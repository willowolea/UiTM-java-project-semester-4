...
<html lang="en">
  <head>
    ...
    <%
        String popupMessage2 = (String) session.getAttribute("popupMessage2");
    ...
    <%
            session.removeAttribute("popupMessage2"); // Remove the message after displaying
        }
    %>
</head>
  <style>
    ...
    *{
    ...
    .main-container h1 {
        ...
        width: 81%; /* Match the table's width */
    }
    ...
    .table-container table {
        width: 90%; /* Table spans the full container width */
    ...
    <main class="main-container">
            ...
            <div class="search-container">
              ...
              <button id="search-button"><i class="fa-solid fa-magnifying-glass"></i></button>
                ...
                <div class="input-container">
                    <a href="addCategory.jsp"><button class="button-create-category">Create Category</button></a>
                </div>
            </div>
        </div>
        ...
        <div class="sorting-container">
            <div class="icon" id="display-container-category">
                ...
                <button class="filter-button" value="category">Category</button>
            </div>
          </div>
        </div>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th>ID</th>
                        <th class="category-title">Category Name</th>
                        <th>Actions</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="category-name"><%=rs.getString("categoryName") %></td>
                        <td>
                            <div class="action-container">
                                <a href="updateCategory.jsp?categoryID=<%= rs.getString("categoryID") %>"><button class="edit-button"><i class="fa-regular fa-pen-to-square"></i></button></a>
                                <a href="javascript:void(0);" onclick="deleteItem('Category', 'categoryID', '<%= rs.getString("categoryID") %>')">
    ...
    <script>
        ...
        document.getElementById("search-button").addEventListener("click", function () {
            ...
            const categoryName = row.children[1].textContent.toLowerCase();
              ...
              if (categoryID.includes(searchBox) || categoryName.includes(searchBox)) {
